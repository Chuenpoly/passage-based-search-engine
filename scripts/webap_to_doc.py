'''This scirpt remove the suffix of the doc id for the document-based retrieval method.
Note that because the some raw file of the documents have duplicated which make the evaluation failed,
so i need to use max operator to eliminate the duplicated documents.'''

from collections import defaultdict

input_file = 'collection/processing/batch_retrieval_results/run.webap.bm25tuned.trec'
output_file = 'collection/processing/document_results/run.webap.bm25tuned.doc.trec'
